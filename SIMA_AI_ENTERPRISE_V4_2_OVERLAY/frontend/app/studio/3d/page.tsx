...
export default function Page(){
  ...
  async function loadState(){
    ...
    if(d.state && group.current){ group.current.traverse((o:any)=>{ if(o.isMesh) o.material = new THREE.MeshStandardMaterial({color:new THREE.Color(d.state.color||'#ccc')}); }); group.current.scale.setScalar(d.state.scale||1); }
  }
